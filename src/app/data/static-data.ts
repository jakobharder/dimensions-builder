...
export const minifigs: MinifigData[] = [
    { id: 7120401, name: 'The Doctor', skillIds: [7, 10, 18, 23, Ability.Level_DoctorWho, Ability.Adventure_DoctorWho], packId: 71204, image: '712041to1MFMUGSHOTDr Who168' },
    ...
    { id: 7120301, name: 'Chell', skillIds: [15, 38, Ability.Level_Portal2, Ability.Adventure_Portal2], packId: 71203, image: '71203_1to1_MF_MUGSHOT_Chell_168' },
    { id: 7120101, name: 'Marty McFly', skillIds: [18, Ability.Level_BackToTheFuture, Ability.Adventure_BackToTheFuture], packId: 71201, image: '71201_1to1_MF_MUGSHOT_Marty_168' },
    { id: 7123501, name: 'Gamer Kid', skillIds: [2, 12, 37, 44, 45, Ability.Level_Midway, Ability.Adventure_Midway], packId: 71235, image: '71235_1to1_MF_MUGSHOT_Retro_Gamer_168' },
    { id: 7122801, name: 'Peter Venkman', skillIds: [12, 34, 56, Ability.Level_Ghostbusters, Ability.Adventure_Ghostbusters], packId: 71228, image: '71228_1to1_MF_MUGSHOT_Peter_168' },
    { id: 7124801, name: 'Ethan Hunt', skillIds: [Ability.Target, Ability.SilverDestroy, Ability.Stealth, Ability.XRay, Ability.Grapple, Ability.Technology, Ability.Drone, Ability.Disguise, Ability.Invisibility, Ability.Climb, Ability.Acrobat, Ability.Dive, Ability.Level_MissionImpossible, Ability.Adventure_MissionImpossible], packId: 71248, image: 'wave-6-ethan-hunt' },
    { id: 7124501, name: 'Finn', skillIds: [Ability.SwordSwitching, Ability.Acrobat, Ability.VineCutting, Ability.DemonDestroy, Ability.Grapple, Ability.LaserDeflector, Ability.Laser, Ability.Target, Ability.Electricity, Ability.Swing, Ability.Level_AdventureTime, Ability.Adventure_AdventureTime], packId: 71245, image: 'wave-6-finn' }, /* vine cutting = gras sword */
    /*{ id: 7124401, name: 'Sonic the Hedgehog', skillIds: [], packId: 71244, image: 'wave-6-sonic-the-hedgehog' },*/
    { id: 7120501, name: 'Owen', skillIds: [22, 26, 27, 37, Ability.Adventure_JurassicWorld], packId: 71205, image: '75917_1to1_MF_OWEN_MUGSHOT_168' },
    { id: 7120502, name: 'ACU Trooper', skillIds: [6, 31, Ability.Adventure_JurassicWorld], packId: 71205, image: '75916_1to1_MF_ACU_MUGSHOT_168' },
    { id: 7120601, name: 'Scooby Doo', skillIds: [3, 4, 26, 37, 49, Ability.DivePlusDigging, Ability.DivePlusTracking, Ability.Adventure_ScoobyDoo], packId: 71206, image: '75900_Scooby_ft_Mugshot_168x224' },// stealth?
    { id: 7120602, name: 'Shaggy', skillIds: [26, Ability.Illumination, 37, 49, Ability.Adventure_ScoobyDoo], packId: 71206, image: '75901_Shaggy_Mugshot_168x224' },//stealth??
    { id: 7120701, name: 'Kai', skillIds: [20, 37, 38, 39, Ability.Adventure_Ninjago], packId: 71207, image: '71207_1to1_MF_MUGSHOT_Kai_168' }, // fire?
    { id: 7120702, name: 'Cole', skillIds: [2, 20, 38, 39, 37, Ability.Adventure_Ninjago], packId: 71207, image: '71207_1to1_MF_MUGSHOT_Cole_168' },
    { id: 7122901, name: 'Joker', skillIds: [6, 22, 34, 36, Ability.Adventure_DC], packId: 71229, image: '71229_1to1_MF_MUGSHOT_Joker_168' },
    { id: 7122902, name: 'Harley Quinn', skillIds: [2, 38, Ability.Adventure_DC], packId: 71229, image: '71229_1to1_MF_MUGSHOT_Harley_Quinn_168' },
    { id: 7124601, name: 'Jake', skillIds: [Ability.Grapple, Ability.Illumination, Ability.Digging, Ability.SlurpAccess, Ability.BigTransformation, Ability.Drilling, Ability.Dive, Ability.Gyrosphere, Ability.MiniAccess, Ability.SuperStrength, Ability.Adventure_AdventureTime], packId: 71246, image: 'wave-6-jake' },
    { id: 7124602, name: 'Lumpy Space Princess', skillIds: [Ability.Boomerang, Ability.MiniAccess, Ability.SlurpAccess, Ability.RainbowLego, Ability.Adventure_AdventureTime], packId: 71246, image: 'wave-6-lumpy-space-princess' },
    { id: 7124701, name: 'Harry Potter', skillIds: [Ability.Laser, Ability.Flying, Ability.Magic, Ability.Illumination, Ability.MagicShield, Ability.Diffindo, Ability.Parseltongue, Ability.Stealth, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.FlightPlusLaser, Ability.Adventure_HarryPotter], packId: 71247, image: 'wave-6-harry-potter' },
    { id: 7124702, name: 'Lord Voldemort', skillIds: [Ability.Laser, Ability.Flying, Ability.Magic, Ability.DarkArts, Ability.MagicShield, Ability.Illumination, Ability.Diffindo, Ability.MindControl, Ability.SilverDestroy, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.FlightPlusLaser, Ability.Adventure_HarryPotter], packId: 71247, image: 'wave-6-lord-voldemort' },
    { id: 7120901, name: 'Wonder Woman', skillIds: [2, 4, 38, 39, 35, 36, 41, 43, 44, Ability.DivePlusBoomerang, Ability.DivePlusGrapple, Ability.DivePlusSuperStrength, Ability.Adventure_DC], packId: 71209,
        image: '71209_1to1_MF_MUGSHOT_Wonder_Woman_168' },
    { id: 7121001, name: 'Cyborg', skillIds: [2, 4, 12, 22, 23, 33, Ability.DivePlusLazer, Ability.DivePlusTarget, Ability.Adventure_DC], packId: 71210, image: '76028_Cyorg_1488x1984_mugshot_360w_2x' },
    { id: 7121101, name: 'Bart Simpson', skillIds: [13, 22, Ability.Adventure_Simpsons], packId: 71211, image: '71211_1to1_MF_MUGSHOT_Bart_168' },
    { id: 7121201, name: 'Emmet', skillIds: [5, 7, 42, Ability.Adventure_LegoMovie], packId: 71212, image: '70810_MF_Mugshot_Emmet_168' },
    { id: 7121301, name: 'Bad Cop', skillIds: [12, 22, 32, Ability.Adventure_LegoMovie], packId: 71213, image: '70819_MF_Mugshot_BadCop_168' },
    { id: 7121401, name: 'Benny', skillIds: [10, 18, 22, 23, 42, 49, Ability.Adventure_LegoMovie], packId: 71214, image: '70810_MF_Mugshot_Benny_168' },
    { id: 7121501, name: 'Jay', skillIds: [6, 7, 20, 37, 38, Ability.Adventure_Ninjago], packId: 71215, image: '71215_1to1_MF_MUGSHOT_Jay_168' },
    { id: 7121601, name: 'Nya', skillIds: [7, 20, 37, 38, 39, Ability.Adventure_Ninjago], packId: 71216, image: '71216_1to1_MF_MUGSHOT_Nya_168' },//7 fix-it?
    { id: 7121701, name: 'Zane', skillIds: [4, 20, 30, 35, 37, 38, Ability.DivePlusXRay, Ability.Adventure_Ninjago], packId: 71217, image: '71217_1to1_MF_MUGSHOT_Zane_168' },
    { id: 7121801, name: 'Gollum', skillIds: [4, 13, 35, 38, Ability.DivePlusBoomerang, Ability.DivePlusMini, Ability.DivePlusSilverDestroy, Ability.Adventure_LordOfTheRing], packId: 71218, image: '9470_1to1_MF_MUGSHOT_Gollum_168' },
    { id: 7121901, name: 'Legolas', skillIds: [14, 22, 38, , Ability.Adventure_LordOfTheRing], packId: 71219, image: '9473_1to1_MF_MUGSHOT_Legolas_168' },//14?
    { id: 7122001, name: 'Gimli', skillIds: [2, 13, , Ability.Adventure_LordOfTheRing], packId: 71220, image: '79008_Gimli_168' },
    { id: 7122101, name: 'Wicked Witch', skillIds: [17, 31, 41, 43, 46, 47, Ability.Adventure_Oz], packId: 71221,
        image: '71221_1to1_MF_MUGSHOT_WickedWitch_168' },
    { id: 7122201, name: 'Laval', skillIds: [1, 2, 38, 39, Ability.Adventure_Chima], packId: 71222, image: '70144_1to1_MF_Laval_01_336_744w' },
    { id: 7122301, name: 'Cragger', skillIds: [1, 2, 4, 34, Ability.DivePlusChi, Ability.DivePlusSuperStrength, Ability.Adventure_Chima], packId: 71223, image: '70150_1to1_MF_Cragger_336_744w' },
    { id: 7122701, name: 'Krusty', skillIds: [11, Ability.WaterSpray, 52, Ability.WaterSprayOrIce, Ability.Adventure_DC], packId: 71227, image: '71005_Portrait_Krusty' },
    { id: 7123001, name: 'Doc Brown', skillIds: [7, 10, 23, 40, Ability.Adventure_BackToTheFuture], packId: 71230, image: '71230_1to1_MF_MUGSHOT_Doc_Brown_168' },
    { id: 7123101, name: 'Unikitty', skillIds: [16, 33, 42, Ability.Adventure_LegoMovie], packId: 71231, image: '70803_MF_Mugshot_Unikitty_168' },
    { id: 7123201, name: 'Eris', skillIds: [1, 2, 22, 43, Ability.Adventure_Chima], packId: 71232, image: '70142_1to1_MF_Eris_01_168' },
    { id: 7123301, name: 'Stay Puft', skillIds: [2, 33, 34, Ability.Adventure_Ghostbusters], packId: 71233, image: '71233_1to1_MF_MUGSHOT_Stay_Puft_168' },
    { id: 7123401, name: 'Sensei Wu', skillIds: [14, 20, 37, 38, 49, Ability.Adventure_Ninjago], packId: 71234, image: '71234_1to1_MF_MUGSHOT_Sensei_Wu_168' },
    { id: 7123601, name: 'Superman', skillIds: [2, 4, 12, 30, 43, 44, Ability.Ice, Ability.DivePlusLazer, Ability.DivePlusSuperStrength, Ability.DivePlusXRay, Ability.FlightPlusLaser, Ability.WaterSprayOrIce, Ability.Adventure_DC], packId: 71236, image: '71236_1to1_MF_MUGSHOT_Superman_168' },
    ...
    { id: 7123801, name: 'Cyberman', skillIds: [4, 10, 17, 23, 30, 40, 41, Ability.DivePlusDrone, Ability.DivePlusHacking, Ability.DivePlusLazer, Ability.DivePlusSilverDestroy, Ability.DivePlusTechnology, Ability.DivePlusXRay, Ability.Adventure_DC], packId: 71238, image: '71238_1to1_MF_MUGSHOT_Gyberman_168' },
...
export const vehicles: VehicleData[] = [
    ...
    { id: 71203041, name: 'Companion Cube', skillIds: [29], packId: 71203, image: 'none', stage: 1, vehicleId: 7120403 },
    { id: 71203042, name: 'Laser Deflector', skillIds: [29, 39], packId: 71203, image: 'none', stage: 2, vehicleId: 7120403 },
    { id: 71203043, name: 'Gold Heart Emitter', skillIds: [29], packId: 71203, image: 'none', stage: 3, vehicleId: 7120403 },
