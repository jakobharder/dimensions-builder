...
export const skills: SkillData[] = [
    ...
    { id: 13, url: '', name: 'Mini Access', desc: 'Enter small hatches' },
    { id: 14, url: '', name: 'Pole Vault', desc: 'Create extra twirl poles' },
    { id: 15, url: '', name: 'Portal Gun', desc: 'Fire portals at white LEGO panels to reach other areas' },
    { id: 16, url: '', name: 'Rainbow LEGO', desc: 'Smash rainbow LEGO objects' },
    { id: 17, url: '', name: 'Silver Destroy', desc: 'Destroy silver LEGO objects' },
    { id: 18, url: '', name: 'Sonar Smash', desc: 'Destroy sonar glass' },
    { id: 19, url: '', name: 'Trap Ghosts', desc: 'Clear ghostly swarms' },
    { id: 20, url: '', name: 'Spinjitzu', desc: 'Use Spinjitzu switches' },
    { id: 22, url: 'target', name: 'Target', desc: 'use target switches' },
    { id: 23, url: '', name: 'Technology', desc: 'Use techno panels' },
    { id: 25, url: '', name: 'Tow Bar', desc: 'Pull down weak LEGO walls' },
    { id: 26, url: '', name: 'Tracking', desc: 'Track trails' },
    { id: 27, url: '', name: 'Vine Cutting', desc: 'cut vines' },
    { id: 28, url: '', name: 'Water Spray', desc: 'Grow LEGO plants' },
    { id: 29, url: '', name: 'Weight Switch', desc: 'Place on cube switches' },
    { id: 30, url: '', name: 'X-Ray Vision', desc: 'See through green LEGO walls' },
    { id: 31, url: '', name: 'Illumination', desc: '' },
    { id: 32, url: '', name: 'Relic Detector', desc: '' },
    { id: 33, url: '', name: 'Big Transformation', desc: '' },
    { id: 34, url: '', name: 'Hazard Protection', desc: '' },
    { id: 35, url: '', name: 'Boomerang', desc: '' },
    { id: 36, url: '', name: 'Grapple', desc: '' },
    { id: 37, url: '', name: 'Stealth', desc: '' },
    { id: 38, url: '', name: 'Acrobat', desc: '' },
    { id: 39, url: '', name: 'Laser Deflector', desc: ''},
    { id: 40, url: '', name: 'Drone', desc: ''},
    { id: 41, url: '', name: 'Mind Control', desc: '' },
    { id: 42, url: '', name: 'Master Build', desc: '' }, // Emmet has?
    { id: 43, url: '', name: 'Flying', desc: '' },
    { id: 44, url: '', name: 'Invulnerability', desc: '' },
    { id: 45, url: '', name: 'Speed', desc: ''},
    { id: 46, url: '', name: 'Magic', desc: ''},
    { id: 47, url: '', name: 'Magic Shield', desc: ''},
    { id: 48, url: '', name: 'Ice', desc: ''},
    { id: 49, url: '', name: 'Gliding', desc: '' },
    { id: 50, url: '', name: 'Accelerator Switch', desc: '' },
    { id: 51, url: '', name: 'Cargo Hook', desc: '' },
    { id: 52, url: '', name: 'Growth', desc: '' },
    { id: 53, url: '', name: 'Time Travel Switch', desc: '' },
    { id: 54, url: '', name: 'TARDIS Pad', desc: '' },
    { id: 55, url: '', name: 'Arcade Station', desc: '' },
    { id: 56, url: '', name: 'Suspend Ghost', desc: '' }
];
