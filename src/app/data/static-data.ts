...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7124501, name: 'Finn', skillIds: [Ability.SwordSwitching, Ability.Acrobat, Ability.VineCutting, Ability.DemonDestroy, Ability.Grapple, Ability.LaserDeflector, Ability.Laser, Ability.Target, Ability.Electricity, Ability.Swing, Ability.Level_AdventureTime, Ability.Adventure_AdventureTime], packId: 71245, image: 'wave-6-finn', state: PieceState.New }, /* vine cutting = gras sword */
