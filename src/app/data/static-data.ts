...
export const skills: SkillData[] = [
    ...
    { id: 23, url: 'technology', name: 'Technology', desc: 'Use techno panels' },
    ...
    { id: 31, url: 'illumination', name: 'Illumination', desc: '' },
    { id: 32, url: 'relic-detector', name: 'Relic Detector', desc: '' },
    { id: 33, url: 'big-transformation', name: 'Big Transformation', desc: '' },
    { id: 34, url: 'hazard-protection', name: 'Hazard Protection', desc: '' },
    { id: 35, url: 'boomerang', name: 'Boomerang', desc: '' },
    { id: 36, url: 'grapple', name: 'Grapple', desc: '' },
    { id: 37, url: 'stealth', name: 'Stealth', desc: '' },
    { id: 38, url: 'acrobat', name: 'Acrobat', desc: '' },
    { id: 39, url: 'laser-deflector', name: 'Laser Deflector', desc: ''},
    { id: 40, url: 'drone', name: 'Drone', desc: ''},
    { id: 41, url: 'mind-control', name: 'Mind Control', desc: '' },
    { id: 42, url: 'master-build', name: 'Master Build', desc: '' }, // Emmet has?
    { id: 43, url: 'flying', name: 'Flying', desc: '' },
    { id: 44, url: 'invulnerability', name: 'Invulnerability', desc: '' },
    { id: 45, url: 'speed', name: 'Speed', desc: ''},
    { id: 46, url: 'magic', name: 'Magic', desc: ''},
    { id: 47, url: 'magic-shield', name: 'Magic Shield', desc: ''},
    { id: 48, url: 'ice', name: 'Ice', desc: ''},
    { id: 49, url: 'gliding', name: 'Gliding', desc: '' },
    { id: 50, url: 'accelerator-switch', name: 'Accelerator Switch', desc: '' },
    { id: 51, url: 'cargo-hook', name: 'Cargo Hook', desc: '' },
    { id: 52, url: 'growth', name: 'Growth', desc: '' },
    { id: 53, url: 'time-travel-switch', name: 'Time Travel Switch', desc: '' },
    { id: 54, url: 'tardis-pad', name: 'TARDIS Pad', desc: '' },
    { id: 55, url: 'arcade-station', name: 'Arcade Station', desc: '' },
    { id: 56, url: 'suspend-ghost', name: 'Suspend Ghost', desc: '' }
];
