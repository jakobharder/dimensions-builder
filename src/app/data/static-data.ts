...
export const packs: Pack[] = [
    ...
    { id: 71204, wave: 2, year: 1, minifigs: [], name: 'Doctor Who', type: PackType.LevelPack, image: '03_LD_PO_LP_DocWho', desc: '' },
    { id: 71203, wave: 1, year: 1, minifigs: [], name: 'Portal® 2', type: PackType.LevelPack, image: '03_LD_PO_LP_Portal', desc: '' },
    { id: 71229, wave: 3, year: 1, minifigs: [], name: 'DC Comics™', type: PackType.TeamPack, image: '03_LD_PO_FP_DC_Joker_Harley', desc: '' },
    { id: 71207, wave: 2, year: 1, minifigs: [], name: 'Lego® Ninjago™',
        type: PackType.TeamPack, image: '03_LD_PO_TP_Ninjago_Kai_Cole', desc: '' },
    { id: 71206, wave: 1, year: 1, minifigs: [], name: 'Scooby-Doo!™', type: PackType.TeamPack, image: '03_LD_PO_TP_ScoobyDoo', desc: '' },
    { id: 71241, wave: 5, year: 1, minifigs: [], name: 'Slimer', type: PackType.FunPack, image: '03_LD_PO_FP_GB_Slimer', desc: '' },
    { id: 71240, wave: 5, year: 1, minifigs: [], name: 'Bane', type: PackType.FunPack, image: '03_LD_PO_FP_DC_Bane', desc: '' },
    { id: 71239, wave: 5, year: 1, minifigs: [], name: 'Lloyd', type: PackType.FunPack, image: '03_LD_PO_FP_Ninjago_Lloyd', desc: '' },
    { id: 71237, wave: 4, year: 1, minifigs: [], name: 'Aquaman', type: PackType.FunPack, image: '03_LD_PO_FP_DC_Aquaman', desc: '' },
    { id: 71236, wave: 4, year: 1, minifigs: [], name: 'Superman', type: PackType.FunPack, image: '03_LD_PO_FP_DC_Superman', desc: '' },
    { id: 71233, wave: 4, year: 1, minifigs: [], name: 'Stay Puft', type: PackType.FunPack, image: '03_LD_PO_FP_GB_StayPuft', desc: '' },
    { id: 71238, wave: 3, year: 1, minifigs: [], name: 'Cyberman', type: PackType.FunPack, image: '03_LD_PO_FP_DrWho_Cyberman', desc: '' },
    { id: 71234, wave: 3, year: 1, minifigs: [], name: 'Sensei Wu', type: PackType.FunPack, image: '03_LD_PO_FP_Ninjago_SenseiWu', desc: '' },
    { id: 71230, wave: 3, year: 1, minifigs: [], name: 'Doc Brown', type: PackType.FunPack, image: '03_LD_PO_FP_BTTF_DocBrown', desc: '' },
    { id: 71231, wave: 2, year: 1, minifigs: [], name: 'Unikitty', type: PackType.FunPack, image: '03_LD_PO_FP_Unikitty', desc: '' },
    { id: 71209, wave: 1, year: 1, minifigs: [], name: 'Wonder Woman', type: PackType.FunPack, image: '03_LD_PO_FP_DC_WonderWoman', desc: '' },
    { id: 71210, wave: 1, year: 1, minifigs: [], name: 'Cyborg', type: PackType.FunPack, image: '03_LD_PO_FP_Cyborg', desc: '' },
    { id: 71212, wave: 1, year: 1, minifigs: [], name: 'Emmet', type: PackType.FunPack, image: '03_LD_PO_FP_Emmet', desc: '' },
    { id: 71213, wave: 1, year: 1, minifigs: [], name: 'Bad Cop', type: PackType.FunPack, image: '03_LD_PO_FP_Badcop', desc: '' },
    { id: 71214, wave: 1, year: 1, minifigs: [], name: 'Benny', type: PackType.FunPack, image: '03_LD_PO_FP_Benny', desc: '' },
    { id: 71215, wave: 1, year: 1, minifigs: [], name: 'Jay', type: PackType.FunPack, image: '03_LD_PO_FP_Ninjago_Jay', desc: '' },
    { id: 71216, wave: 1, year: 1, minifigs: [], name: 'Nya', type: PackType.FunPack, image: '03_LD_PO_FP_Ninjago_Nya', desc: '' },
    { id: 71217, wave: 1, year: 1, minifigs: [], name: 'Zane', type: PackType.FunPack, image: '03_LD_PO_FP_Ninjago_Zane', desc: '' },
    { id: 71218, wave: 1, year: 1, minifigs: [], name: 'Gollum', type: PackType.FunPack, image: '03_LD_PO_FP_LOTR_Gollum', desc: '' },
    { id: 71219, wave: 1, year: 1, minifigs: [], name: 'Legolas', type: PackType.FunPack, image: '03_LD_PO_FP_LOTR_Legolas', desc: '' },
    { id: 71220, wave: 1, year: 1, minifigs: [], name: 'Gimli', type: PackType.FunPack, image: '03_LD_PO_FP_LOTR_Gimli', desc: '' },
    { id: 71221, wave: 1, year: 1, minifigs: [], name: 'Wicked Witch', type: PackType.FunPack, image: '03_LD_PO_FP_WickedWitch', desc: '' },
    { id: 71222, wave: 1, year: 1, minifigs: [], name: 'Laval', type: PackType.FunPack, image: '03_LD_PO_FP_Chima_Laval', desc: '' },
    { id: 71223, wave: 1, year: 1, minifigs: [], name: 'Cragger', type: PackType.FunPack, image: '03_LD_PO_FP_Chima_Cragger', desc: '' },
    { id: 71232, wave: 1, year: 1, minifigs: [], name: 'Eris', type: PackType.FunPack, image: '03_LD_PO_FP_Chima_Eris', desc: '' },
    { id: 71211, wave: 2, year: 1, minifigs: [], name: 'Bart Simpson', type: PackType.FunPack, image: '03_LD_PO_FP_Simpsons_Bart', desc: '' },
    { id: 71227, wave: 2, year: 1, minifigs: [], name: 'Krusty', type: PackType.FunPack, image: '03_LD_PO_FP_Simpsons_Krusty', desc: '' },
    { id: 71245, wave: 6, year: 2, minifigs: [], name: 'Adventure Time', type: PackType.LevelPack, image: 'adventure-time-level-pack', desc: 'This pack has not been released yet. The content is work-in-progress.' },
    { id: 71248, wave: 6, year: 2, minifigs: [], name: 'Mission: Impossible', type: PackType.LevelPack, image: 'mission-impossible-level-pack', desc: 'This pack has not been released yet. The content is work-in-progress.' },
    { id: 71242, wave: 6, year: 2, minifigs: [], name: 'Ghostbusters™', type: PackType.StoryPack, image: 'ghostbusters-story-pack', desc: 'This pack has not been released yet. The content is work-in-progress.' },
    { id: 71246, wave: 6, year: 2, minifigs: [], name: 'Adventure Time', type: PackType.TeamPack, image: 'adventure-time-team-pack', desc: 'This pack has not been released yet. The content is work-in-progress.' },
    { id: 71247, wave: 6, year: 2, minifigs: [], name: 'Harry Potter', type: PackType.TeamPack, image: 'harry-potter-team-pack', desc: 'This pack has not been released yet. The content is work-in-progress.' },
    { id: 71251, wave: 6, year: 2, minifigs: [], name: 'the A-Team', type: PackType.FunPack, image: 'a-team-fun-pack', desc: 'This pack has not been released yet. The content is work-in-progress.' }
];
