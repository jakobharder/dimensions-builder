...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7124201, name: 'Abby Yates', skillIds: [Ability.Laser, Ability.SuspendGhost, Ability.Intelligence, Ability.ChargeTransfer, Ability.Story_Ghostbusters2016, Ability.Adventure_Ghostbusters2016], packId: 71242, image: 'wave-6-abby-yates', state: PieceState.Incomplete }
];
