...
import { PieceState } from './data-types';
...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7124801, name: 'Ethan Hunt', skillIds: [Ability.Target, Ability.SilverDestroy, Ability.Stealth, Ability.XRay, Ability.Grapple, Ability.Technology, Ability.Drone, Ability.Disguise, Ability.Invisibility, Ability.Climb, Ability.Acrobat, Ability.Dive, Ability.Level_MissionImpossible, Ability.Adventure_MissionImpossible], packId: 71248, image: 'wave-6-ethan-hunt', state: PieceState.Incomplete },
    <MinifigData>{ id: 7124501, name: 'Finn', skillIds: [Ability.SwordSwitching, Ability.Acrobat, Ability.VineCutting, Ability.DemonDestroy, Ability.Grapple, Ability.LaserDeflector, Ability.Laser, Ability.Target, Ability.Electricity, Ability.Swing, Ability.PoleVault, Ability.Level_AdventureTime, Ability.Adventure_AdventureTime], packId: 71245, image: 'wave-6-finn', state: PieceState.New }, /* vine cutting = gras sword */
    ...
    <MinifigData>{ id: 7124601, name: 'Jake', skillIds: [Ability.Grapple, Ability.Illumination, Ability.Digging, Ability.SlurpAccess, Ability.BigTransformation, Ability.Drilling, Ability.Dive, Ability.Gyrosphere, Ability.MiniAccess, Ability.SuperStrength, Ability.Adventure_AdventureTime], packId: 71246, image: 'wave-6-jake', state: PieceState.Incomplete },
    <MinifigData>{ id: 7124602, name: 'Lumpy Space Princess', skillIds: [Ability.Boomerang, Ability.MiniAccess, Ability.SlurpAccess, Ability.RainbowLego, Ability.Adventure_AdventureTime], packId: 71246, image: 'wave-6-lumpy-space-princess', state: PieceState.Incomplete },
    <MinifigData>{ id: 7124701, name: 'Harry Potter', skillIds: [Ability.Laser, Ability.Flying, Ability.Magic, Ability.Illumination, Ability.MagicShield, Ability.Diffindo, Ability.Parseltongue, Ability.Stealth, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.FlightPlusLaser, Ability.Adventure_HarryPotter], packId: 71247, image: 'wave-6-harry-potter', state: PieceState.Incomplete },
    <MinifigData>{ id: 7124702, name: 'Lord Voldemort', skillIds: [Ability.Laser, Ability.Flying, Ability.Magic, Ability.DarkArts, Ability.MagicShield, Ability.Illumination, Ability.Diffindo, Ability.MindControl, Ability.SilverDestroy, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.FlightPlusLaser, Ability.Adventure_HarryPotter], packId: 71247, image: 'wave-6-lord-voldemort', state: PieceState.Incomplete },
    ...
    <MinifigData>{ id: 7122701, name: 'Krusty', skillIds: [11, Ability.WaterSpray, 52, Ability.WaterSprayOrIce, Ability.Adventure_DC], packId: 71227, image: '71005_Portrait_Krusty' },
    ...
    <MinifigData>{ id: 7124101, name: 'Slimer', skillIds: [4, 11, 13, 18, 31, 34, 35, 43, Ability.DivePlusBoomerang, Ability.DivePlusGhostImmunity, Ability.DivePlusHazardCleaner, Ability.DivePlusMini, Ability.DivePlusSonarSmash, Ability.SlurpAccess, Ability.Adventure_Ghostbusters], packId: 71241, image: '71241_1to1_MF_MUGSHOT_Slimer_168' },
    <MinifigData>{ id: 7125101, name: 'B.A. Baracus', skillIds: [Ability.FixIt, Ability.SuperStrength, Ability.LaserDeflector, Ability.MasterBuild, Ability.Target, Ability.SilverDestroy, Ability.Adventure_ATeam], packId: 71251, image: 'wave-6-ba-baracus', state: PieceState.Incomplete },
    ...
    <MinifigData>{ id: 7134401, name: 'Excalibur Batman', skillIds: [Ability.SwordSwitching, Ability.MasterBuild, Ability.VineCutting, Ability.Adventure_Batman], packId: 71344, image: 'wave-7.5-excalibur-batman', state: PieceState.Incomplete },
    ...
    <MinifigData>{ id: 7124201, name: 'Abby Yates', skillIds: [Ability.Laser, Ability.SuspendGhost, Ability.IntelligenceAccess, Ability.ChargeTransfer, Ability.Story_Ghostbusters2016, Ability.Adventure_Ghostbusters2016], packId: 71242, image: 'wave-6-abby-yates', state: PieceState.Incomplete }
];
