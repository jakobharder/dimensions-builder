...
export const minifigs: MinifigData[] = [
    ...
    { id: 7123601, name: 'Superman', skillIds: [2, 4, 12, 30, 43, 44, 48, 1010, 1014, 1018, 1019], packId: 71236, image: '71236_1to1_MF_MUGSHOT_Superman_168' },
    { id: 7123701, name: 'Aquaman', skillIds: [0, 4, 11, 28, 52, 1009], packId: 71237, image: '71237_1to1_MF_MUGSHOT_Aquaman_168' },
    { id: 7123801, name: 'Cyberman', skillIds: [4, 10, 17, 23, 30, 40, 41, 1005, 1008, 1010, 1012, 1016, 1018], packId: 71238, image: '71238_1to1_MF_MUGSHOT_Gyberman_168' },
