...
export const minifigs: MinifigData[] = [
    ...
    { id: 7124601, name: 'Jake', skillIds: [Ability.Grapple, Ability.Illumination, Ability.Digging, Ability.SlurpAccess, Ability.BigTransformation, Ability.Drilling, Ability.Dive, Ability.Gyrosphere, Ability.MiniAccess, Ability.SuperStrength], packId: 71246, image: 'wave-6-jake' },
    { id: 7124602, name: 'Lumpy Space Princess', skillIds: [Ability.Boomerang, Ability.MiniAccess, Ability.SlurpAccess, Ability.RainbowLego], packId: 71246, image: 'wave-6-lumpy-space-princess' },
    { id: 7124701, name: 'Harry Potter', skillIds: [Ability.Laser, Ability.Flying, Ability.Magic, Ability.Illumination, Ability.MagicShield, Ability.Diffindo, Ability.Parseltongue, Ability.Stealth, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.FlightPlusLaser], packId: 71247, image: 'wave-6-harry-potter' },
    { id: 7124702, name: 'Lord Voldemort', skillIds: [Ability.Laser, Ability.Flying, Ability.Magic, Ability.DarkArts, Ability.MagicShield, Ability.Illumination, Ability.Diffindo, Ability.MindControl, Ability.SilverDestroy, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.FlightPlusLaser], packId: 71247, image: 'wave-6-lord-voldemort' },
