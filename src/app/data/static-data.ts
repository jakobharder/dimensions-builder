...
export const packs: PackData[] = [
    ...
    <PackData>{ id: 71255, wave: 9, year: 2, minifigs: [], builds: [], name: 'Teen Titans Go!', type: PackType.TeamPack, image: 'wave-9-teen-titans-go-team-pack', desc: '', amazon: null },
    ...
    <PackData>{ id: 71346, wave: 9, year: 2, minifigs: [], builds: [], name: 'Powerpuff Girls', type: PackType.TeamPack, image: 'wave-9-powerpuff-girls-team-pack', desc: '', amazon: null }
