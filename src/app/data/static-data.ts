...
export const packs: PackData[] = [
    ...
    { id: 71245, wave: 6, year: 2, minifigs: [], builds: [], name: 'Adventure Time', type: PackType.LevelPack, image: 'adventure-time-level-pack', desc: '' },
    { id: 71248, wave: 6, year: 2, minifigs: [], builds: [], name: 'Mission: Impossible', type: PackType.LevelPack, image: 'mission-impossible-level-pack', desc: '' },
    { id: 71242, wave: 6, year: 2, minifigs: [], builds: [], name: 'Ghostbusters™', type: PackType.StoryPack, image: 'ghostbusters-story-pack', desc: '' },
    { id: 71246, wave: 6, year: 2, minifigs: [], builds: [], name: 'Adventure Time', type: PackType.TeamPack, image: 'adventure-time-team-pack', desc: '' },
    { id: 71247, wave: 6, year: 2, minifigs: [], builds: [], name: 'Harry Potter', type: PackType.TeamPack, image: 'harry-potter-team-pack', desc: '' },
    { id: 71251, wave: 6, year: 2, minifigs: [], builds: [], name: 'the A-Team', type: PackType.FunPack, image: 'a-team-fun-pack', desc: '' },
    { id: 71253, wave: 7, year: 2, minifigs: [], builds: [], name: 'Fantastic Beasts and Where to Find Them', type: PackType.StoryPack, image: 'wave-7-fantastic-beasts-story-pack', desc: '' },
    { id: 71257, wave: 7, year: 2, minifigs: [], builds: [], name: 'Tina Goldstein', type: PackType.FunPack, image: 'wave-7-tina-goldstein-fun-pack', desc: '' },
    { id: 71244, wave: 7, year: 2, minifigs: [], builds: [], name: 'Sonic the Hedgehog', type: PackType.LevelPack, image: 'wave-7-sonic-level-pack', desc: '' },
