...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7124702, name: 'Lord Voldemort', skillIds: [/*Ability.Laser, Ability.LaserDeflector, */Ability.Flying, Ability.Magic, Ability.MagicShield, Ability.Illumination, Ability.Diffindo, Ability.MindControl, Ability.SilverDestroy, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.Growth, Ability.HazardCleaner, Ability.Adventure_HarryPotter], packId: 71247, image: 'wave-6-lord-voldemort', state: PieceState.New },
