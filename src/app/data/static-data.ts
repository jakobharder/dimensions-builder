...
export const packs: Pack[] = [
    { id: 71205, wave: 1, year: 1, minifigs: [], name: 'Jurassic World™',
    ...
    { id: 71201, wave: 1, year: 1, minifigs: [], name: 'Back to the Future™',
        type: PackType.LevelPack, image: '03_LD_PO_LP_BTTF_Marty' },
    { id: 71202, wave: 1, year: 1, minifigs: [], name: 'The Simpsons™',
        type: PackType.LevelPack, image: '03_LD_PO_LP_Simpsons_Homer' },
    { id: 71235, wave: 4, year: 1, minifigs: [], name: 'Midway Arcade™',
        type: PackType.LevelPack, image: '03_LD_PO_FP_GB_INTL_GamerKid'},
    { id: 71228, wave: 3, year: 1, minifigs: [], name: 'Ghostbusters™',
    ...
    { id: 71203, wave: 1, year: 1, minifigs: [], name: 'Portal® 2', type: PackType.LevelPack, image: '03_LD_PO_LP_Portal'},
    { id: 71229, wave: 3, year: 1, minifigs: [], name: 'DC Comics™', type: PackType.TeamPack, image: '03_LD_PO_FP_DC_Joker_Harley'},
    { id: 71207, wave: 2, year: 1, minifigs: [], name: 'Lego® Ninjago™',
        type: PackType.TeamPack, image: '03_LD_PO_TP_Ninjago_Kai_Cole'},
    { id: 71206, wave: 1, year: 1, minifigs: [], name: 'Scooby-Doo!™', type: PackType.TeamPack, image: '03_LD_PO_TP_ScoobyDoo'},
...
export const minifigs: MinifigData[] = [
    ...
    { id: 7120601, name: 'Scooby Doo', skillIds: [3, 4, 26, 37, 49, 1001, 1017], packId: 71206, image: '75900_Scooby_ft_Mugshot_168x224' },// stealth?
    ...
    { id: 7120901, name: 'Wonder Woman', skillIds: [2, 4, 38, 39, 35, 36, 41, 43, 44, 1003, 1007, 1014], packId: 71209,
        image: '71209_1to1_MF_MUGSHOT_Wonder_Woman_168' },
    { id: 7121001, name: 'Cyborg', skillIds: [2, 4, 12, 22, 23, 33, 1010, 1015], packId: 71210, image: '76028_Cyorg_1488x1984_mugshot_360w_2x' },
    ...
    { id: 7121701, name: 'Zane', skillIds: [4, 20, 30, 35, 37, 38, 1018], packId: 71217, image: '71217_1to1_MF_MUGSHOT_Zane_168' },
    { id: 7121801, name: 'Gollum', skillIds: [4, 13, 35, 38, 1003, 1011, 1012], packId: 71218, image: '9470_1to1_MF_MUGSHOT_Gollum_168' },
    ...
    { id: 7122301, name: 'Cragger', skillIds: [1, 2, 4, 34, 1004, 1014], packId: 71223, image: '70150_1to1_MF_Cragger_336_744w' },
    ...
    { id: 7123601, name: 'Superman', skillIds: [2, 4, 12, 30, 43, 44, 48, 1002, 1010, 1014, 1018, 1019], packId: 71236, image: '71236_1to1_MF_MUGSHOT_Superman_168' },
    { id: 7123701, name: 'Aquaman', skillIds: [0, 4, 11, 28, 52, 1009], packId: 71237, image: '71237_1to1_MF_MUGSHOT_Aquaman_168' },
    { id: 7123801, name: 'Cyberman', skillIds: [4, 10, 17, 23, 30, 40, 41, 1002, 1005, 1008, 1012, 1016, 1018], packId: 71238, image: '71238_1to1_MF_MUGSHOT_Gyberman_168' },
    ...
    { id: 7124101, name: 'Slimer', skillIds: [4, 11, 13, 18, 31, 34, 35, 43, 1003, 1006, 1009, 1011, 1013], packId: 71241, image: '71241_1to1_MF_MUGSHOT_Slimer_168' },
...
export const vehicles: VehicleData[] = [
    ...
    { id: 71209021, name: 'Invisible Jet', skillIds: [8, 37, 43, 51, 1019], packId: 71209, image: '71209021', stage: 1, vehicleId: 7120902 },
    ...
    { id: 71237021, name: 'Aqua Watercraft', skillIds: [4, 1012, 1015], packId: 71237, image: 'none', stage: 1, vehicleId: 7123702 },
    ...
    { id: 71207031, name: 'Blade\'s Bike', skillIds: [50, 1019], packId: 71207, image: 'none', stage: 1, vehicleId: 7120703 },
    ...
    { id: 71215021, name: 'Storm Fighter', skillIds: [8, 43, 51, 1019], packId: 71215, image: 'none', stage: 1, vehicleId: 7121502 },
    ...
    { id: 71217021, name: 'Ninja Copter', skillIds: [8, 43, 51, 1019], packId: 71217, image: 'none', stage: 1, vehicleId: 7121702 },
    ...
    { id: 71202031, name: 'Homer\'s Car', skillIds: [25, 50, 1012, 1015], packId: 71202, image: 'none', stage: 1, vehicleId: 7120203 },
    ...
    { id: 71223021, name: 'Swamp Skimmer', skillIds: [1012, 1015], packId: 71223, image: 'none', stage: 1, vehicleId: 7122302 },
    ...
    { id: 71204021, name: 'TARDIS', skillIds: [8, 37, 43, 51, 54, 1019], packId: 71204, image: 'none', stage: 1, vehicleId: 7120402 },
    ...
    { id: 71228021, name: 'Ecto-1', skillIds: [50, 1012, 1015], packId: 71228, image: 'none', stage: 1, vehicleId: 7122802 },
    ...
    { id: 71235021, name: 'G-6155 Spy Hunter', skillIds: [25, 50, 1015], packId: 71235, image: 'none', stage: 1, vehicleId: 7123502 },
...
export const skills: SkillData[] = [
    ...
    { id: 1001, url: '', name: 'Dive + Digging', desc: 'use dig spots underwater' },
    { id: 1002, url: '', name: 'Dive + Laser', desc: 'use Laser underwater' },
    { id: 1003, url: '', name: 'Dive + Boomerang', desc: '' },
    { id: 1004, url: '', name: 'Dive + Chi', desc: '' },
    { id: 1005, url: '', name: 'Dive + Drone Access', desc: '' },
    { id: 1006, url: '', name: 'Dive + Ghost Immunity', desc: '' },
    { id: 1007, url: '', name: 'Dive + Grapple', desc: '' },
    { id: 1008, url: '', name: 'Dive + Hacking', desc: '' },
    { id: 1009, url: '', name: 'Dive + Hazard Cleaner', desc: '' },
    { id: 1010, url: '', name: 'Dive + Laser', desc: '' },
    { id: 1011, url: '', name: 'Dive + Mini Access', desc: '' },
    { id: 1012, url: '', name: 'Dive + Silver Lego Destroy', desc: '' },
    { id: 1013, url: '', name: 'Dive + Sonar Smash', desc: '' },
    { id: 1014, url: '', name: 'Dive + Super Strength', desc: '' },
    { id: 1015, url: '', name: 'Dive + Target', desc: '' },
    { id: 1016, url: '', name: 'Dive + Technology', desc: '' },
    { id: 1017, url: '', name: 'Dive + Tracking', desc: '' },
    { id: 1018, url: '', name: 'Dive + X-Ray Vision', desc: '' },
    { id: 1019, url: '', name: 'Flight + Laser', desc: '' },
/*
    { id: , url: '', name: '', desc: '' },
*/
];
