...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7125301, name: 'Newt Scamander', skillIds: [Ability.Magic, Ability.Diffindo, Ability.Illumination, Ability.FixIt, Ability.Flying, Ability.FantasticsBeastsStory, Ability.FantasticsBeastsWorld], 
        packId: 71253, image: 'wave-7-newt-scamander', state: PieceState.Incomplete, url: 'newt-scamander' },
    <MinifigData>{ id: 7124401, name: 'Sonic the Hedgehog', skillIds: [Ability.Speed, Ability.Acrobat, Ability.Flying, Ability.SonicLevel, Ability.SonicWorld], 
        packId: 71244, image: 'wave-7-sonic-the-hedgehog', state: PieceState.Incomplete, url: 'sonic-the-hedgehog' },
    <MinifigData>{ id: 7125601, name: 'Stripe', skillIds: [Ability.MiniAccess, Ability.Target, Ability.VineCutting, Ability.GremlinsWorld], 
        packId: 71256, image: 'wave-7-stripe', state: PieceState.Incomplete, url: 'stripe' },
    <MinifigData>{ id: 7125602, name: 'Gizmo', skillIds: [Ability.MiniAccess, Ability.Gremlin, Ability.Target, Ability.GremlinsWorld], 
        packId: 71256, image: 'wave-7-gizmo', state: PieceState.Incomplete, url: 'gizmo' },
    <MinifigData>{ id: 7125701, name: 'Tina Goldstein', skillIds: [Ability.Magic, Ability.MagicShield, Ability.Illumination, Ability.FantasticsBeastsWorld], 
        packId: 71257, image: 'wave-7-tina-goldstein', state: PieceState.Incomplete, url: 'tina-goldstein' },
    <MinifigData>{ id: 7125801, name: 'E.T.', skillIds: [Ability.Illumination, Ability.FixIt, Ability.Stealth, Ability.Telekinesis, Ability.MiniAccess, Ability.Dive, Ability.Growth, Ability.ETWorld], 
        packId: 71258, image: 'wave-7-e-t', state: PieceState.Incomplete, url: 'e-t' },
    <MinifigData>{ id: 7128501, name: 'Marceline', skillIds: [Ability.SonarSmash, Ability.Flying, Ability.Telekinesis, Ability.Adventure_AdventureTime], 
