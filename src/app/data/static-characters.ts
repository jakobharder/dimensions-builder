...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7120201, name: 'Homer Simpson', skillIds: [Ability.SuperStrength, Ability.SuperStrengthHandles, 18, 33, Ability.SimpsonsLevel, Ability.Adventure_Simpsons], 
    ...
    <MinifigData>{ id: 7120101, name: 'Marty McFly', skillIds: [Ability.SonarSmash, Ability.BackToTheFutureLevel, Ability.Adventure_BackToTheFuture], 
    ...
    <MinifigData>{ id: 7124501, name: 'Finn', skillIds: [Ability.SwordSwitch, Ability.Acrobat, Ability.VineCutting, Ability.RedDemonObjects, Ability.Grapple, Ability.LaserDeflector, Ability.Laser, Ability.Target, Ability.RopeSwings, Ability.PoleVault, Ability.Level_AdventureTime, Ability.Adventure_AdventureTime], 
        packId: 71245, image: 'wave-6-finn', state: PieceState.Done, url: 'finn',
    ...
    <MinifigData>{ id: 7124601, name: 'Jake', skillIds: [Ability.Grapple, Ability.Illumination, Ability.Digging, Ability.SlurpAccess, Ability.BigTransformation, Ability.Drilling, Ability.Dive, Ability.Gyrosphere, Ability.MiniAccess, Ability.SuperStrength, Ability.SuperStrengthHandles, Ability.RopeSwings, Ability.SonarSmash, Ability.Tracking, Ability.Drone, Ability.Adventure_AdventureTime], 
        packId: 71246, image: 'wave-6-jake', state: PieceState.Done, url: 'jake' },
    <MinifigData>{ id: 7124602, name: 'Lumpy Space Princess', skillIds: [Ability.Boomerang, Ability.MiniAccess, Ability.SlurpAccess, Ability.RainbowLego, Ability.HazardProtection, Ability.Adventure_AdventureTime], 
        packId: 71246, image: 'wave-6-lumpy-space-princess', state: PieceState.Done, url: 'lumpy-space-princess' },
    <MinifigData>{ id: 7124701, name: 'Harry Potter', skillIds: [/*Ability.Laser, Ability.LaserDeflector, */Ability.Flying, Ability.HoverOrFlying, Ability.Magic, Ability.Illumination, Ability.MagicShield, Ability.Diffindo, Ability.Parseltongue, Ability.Stealth, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.Growth, Ability.HazardCleaner, Ability.SilverDestroy, Ability.TargetPlusSilver, Ability.ApparateAccess, Ability.Adventure_HarryPotter], 
        packId: 71247, image: 'wave-6-harry-potter', state: PieceState.Done, url: 'harry-potter' },
    <MinifigData>{ id: 7124702, name: 'Lord Voldemort', skillIds: [/*Ability.Laser, Ability.LaserDeflector, */Ability.Flying, Ability.HoverOrFlying, Ability.Magic, Ability.MagicShield, Ability.Illumination, Ability.Diffindo, Ability.Parseltongue, Ability.MindControl, Ability.SilverDestroy, Ability.TargetPlusSilver, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.Growth, Ability.HazardCleaner, Ability.ApparateAccess, Ability.Adventure_HarryPotter], 
        packId: 71247, image: 'wave-6-lord-voldemort', state: PieceState.Done, url: 'lord-voldemort' },
    <MinifigData>{ id: 7120901, name: 'Wonder Woman', skillIds: [Ability.SuperStrength, Ability.SuperStrengthHandles, 4, 38, 39, 35, 36, 41, Ability.Flying, Ability.HoverOrFlying, 44, Ability.DivePlusBoomerang, Ability.DivePlusGrapple, Ability.DivePlusSuperStrength, Ability.Adventure_DC], 
    ...
    <MinifigData>{ id: 7121901, name: 'Legolas', skillIds: [14, 22, 38, Ability.GrindRails, Ability.Adventure_LordOfTheRing], 
    ...
    <MinifigData>{ id: 7122101, name: 'The Wicked Witch', skillIds: [Ability.SilverDestroy, Ability.TargetPlusSilver, 31, 41, Ability.Flying, Ability.HoverOrFlying, 46, 47, Ability.Adventure_Oz], 
    ...
    <MinifigData>{ id: 7123201, name: 'Eris', skillIds: [1, Ability.SuperStrength, Ability.SuperStrengthHandles, 22, Ability.Flying, Ability.HoverOrFlying, Ability.Adventure_Chima], 
    ...
    <MinifigData>{ id: 7123601, name: 'Superman', skillIds: [Ability.SuperStrength, Ability.SuperStrengthHandles, 4, 12, 30, Ability.Flying, Ability.HoverOrFlying, 44, Ability.Ice, Ability.DivePlusLaser, Ability.DivePlusSuperStrength, Ability.DivePlusXRay, Ability.FlightPlusLaser, Ability.WaterSprayOrIce, Ability.Adventure_DC], 
    ...
    <MinifigData>{ id: 7125101, name: 'B.A. Baracus', skillIds: [Ability.FixIt, Ability.SuperStrength, Ability.SuperStrengthHandles, Ability.LaserDeflector, Ability.ATeamMasterBuild, Ability.Target, Ability.SilverDestroy, Ability.Adventure_ATeam], 
        packId: 71251, image: 'wave-6-ba-baracus', state: PieceState.Done, url: 'ba-baracus' },
    ...
    <MinifigData>{ id: 7128601, name: 'Michael Knight', skillIds: [Ability.XRay, Ability.Hacking, Ability.Tracking, Ability.Technology, Ability.Acrobat, Ability.Level_KnightRider, Ability.Adventure_KnightRider], 
        packId: 71286, image: 'wave-7.5-knight-rider', state: PieceState.New, url: 'michael-knight' }, // doging, dash=speed?
    <MinifigData>{ id: 7134401, name: 'Excalibur Batman', skillIds: [Ability.Boomerang, Ability.Stealth, Ability.LaserDeflector, Ability.Grapple, Ability.SuperStrength, Ability.SwordSwitch, Ability.MasterBuild, Ability.VineCutting, Ability.Adventure_Batman], 
        packId: 71344, image: 'wave-7.5-excalibur-batman', state: PieceState.New, url: 'excalibur-batman' },
    <MinifigData>{ id: 7126401, name: 'Batgirl', skillIds: [Ability.Boomerang, Ability.Gliding, Ability.Stealth, Ability.Grapple, Ability.HighSecurityAccess, Ability.DetectiveMode, Ability.Story_Batman, Ability.Adventure_Batman], 
        packId: 71264, image: 'wave-7.5-batgirl', state: PieceState.New, url: 'batgirl' },
    <MinifigData>{ id: 7126402, name: 'Robin', skillIds: [Ability.Dive, Ability.LaserDeflector, Ability.Acrobat, Ability.FixIt, Ability.SlurpAccess, Ability.Illumination, Ability.SuitRip, Ability.PoleVault, Ability.Story_Batman, Ability.Adventure_Batman], 
        packId: 71264, image: 'wave-7.5-robin', state: PieceState.New, url: 'robin' },
    <MinifigData>{ id: 7124201, name: 'Abby Yates', skillIds: [Ability.Laser, Ability.SuspendGhost, Ability.TrapGhosts, Ability.HazardProtection, Ability.SuperStrength, Ability.SuperStrengthHandles, Ability.Intelligence, Ability.ChargeTransfer, Ability.Ghostbusters2016Story, Ability.Adventure_Ghostbusters2016, Ability.Grapple, Ability.RopeSwings, Ability.FixIt, Ability.Technology, Ability.PKEMeter, Ability.TargetPlusSilver, Ability.SilverDestroy], 
        packId: 71242, image: 'wave-6-abby-yates', state: PieceState.Done, url: 'abby-yates',
        comments: [{ title: 'Jillian Holtzmann, Patty Tolan, Erin Gilbert', ids: [Ability.SuperStrength, Ability.SuperStrengthHandles, Ability.Grapple, Ability.RopeSwings, Ability.FixIt, Ability.Technology, Ability.TargetPlusSilver, Ability.SilverDestroy] }, { title: 'unconfirmed', ids: [Ability.HazardProtection]}] },
    <MinifigData>{ id: 7125301, name: 'Newt Scamander', skillIds: [Ability.Magic, Ability.Diffindo, Ability.Illumination, Ability.FixIt, Ability.Flying, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.Target, Ability.LaserDeflector, Ability.SilverDestroy, Ability.Stealth, Ability.Intelligence, Ability.FantasticalBriefcase, Ability.ApparateAccess, Ability.TargetPlusSilver, Ability.FantasticsBeastsStory, Ability.FantasticsBeastsWorld], 
        packId: 71253, image: 'wave-7-newt-scamander', state: PieceState.New, url: 'newt-scamander' },
    <MinifigData>{ id: 7124401, name: 'Sonic the Hedgehog', skillIds: [Ability.Speed, Ability.Acrobat, Ability.GrindRails, Ability.SuperStrength, Ability.SonicLevel, Ability.SonicWorld], 
        packId: 71244, image: 'wave-7-sonic-the-hedgehog', state: PieceState.New, url: 'sonic-the-hedgehog' },
    <MinifigData>{ id: 7125601, name: 'Stripe', skillIds: [Ability.Digging, Ability.Target, Ability.Acrobat, Ability.VineCutting, Ability.GremlinsWorld], 
        packId: 71256, image: 'wave-7-stripe', state: PieceState.New, url: 'stripe' },
    <MinifigData>{ id: 7125602, name: 'Gizmo', skillIds: [Ability.MiniAccess, Ability.Gremlin, Ability.Target, Ability.SilverDestroy, Ability.TargetPlusSilver, Ability.RopeSwings, Ability.Grapple, Ability.GremlinsWorld], 
        packId: 71256, image: 'wave-7-gizmo', state: PieceState.New, url: 'gizmo' },
    <MinifigData>{ id: 7125701, name: 'Tina Goldstein', skillIds: [Ability.Magic, Ability.MagicShield, Ability.Illumination, Ability.Acrobat, Ability.WaterSpray, Ability.WaterSprayOrIce, Ability.Target, Ability.LaserDeflector, Ability.Diffindo, Ability.Flying, Ability.SilverDestroy, Ability.Stealth, Ability.ApparateAccess, Ability.FantasticsBeastsWorld], 
        packId: 71257, image: 'wave-7-tina-goldstein', state: PieceState.New, url: 'tina-goldstein' },
    <MinifigData>{ id: 7125801, name: 'E.T.', skillIds: [Ability.Illumination, Ability.FixIt, Ability.HeartRegen, Ability.Stealth, Ability.MindControl, Ability.Magic, Ability.Growth, Ability.MiniAccess, Ability.ETWorld], 
    ...
    <MinifigData>{ id: 7126701, name: 'Sloth', skillIds: [Ability.GooniesLevel, Ability.GooniesWorld, 
        Ability.SuperStrength, Ability.SuperStrengthHandles, Ability.Grapple, Ability.RopeSwings, Ability.Digging, 
        Ability.Dive, Ability.Target, Ability.DivePlusTarget,
        /*Mikey*/ Ability.MiniAccess, Ability.Intelligence, Ability.SilverDestroy, 
        /*Chunk Target, Mini*/ Ability.TruffleShuffle, 
        /* Brand */ Ability.Acrobat, 
        /*Mouth Mini, Silver, Diggin*/ Ability.LaserDeflector, Ability.HazardProtection, 
        /*Andy Acrobat*/ Ability.SonarSmash,
        /*Stef Target, Dive, Acrobat*/], 
        comments: [
            { title: 'Sloth', ids: [Ability.SuperStrength, Ability.SuperStrengthHandles, Ability.Grapple, 
                Ability.RopeSwings, Ability.Digging, Ability.Dive, Ability.Target, Ability.DivePlusTarget]},
            { title: 'Mikey', ids: [Ability.MiniAccess, Ability.Intelligence, Ability.SilverDestroy] },
            { title: 'Chunk', ids: [Ability.Target, Ability.MiniAccess, Ability.TruffleShuffle] },
            { title: 'Brand', ids: [Ability.Acrobat] },
            { title: 'Andy', ids: [Ability.Acrobat, Ability.SonarSmash] },
            { title: 'Mouth', ids: [Ability.MiniAccess, Ability.SilverDestroy, Ability.Digging, 
    ...
    <MinifigData>{ id: 7126601, name: 'Chase McCain', skillIds: [Ability.Adventure_LegoCity, Ability.Acrobat, 
        ...
        packId: 71266, image: 'wave-8-chase-mccain', state: PieceState.New, url: 'chase-mccain' },
    <MinifigData>{ id: 7134801, name: 'Hermione Granger', skillIds: [Ability.Acrobat, Ability.Magic, 
        Ability.MagicShield, Ability.Illumination, Ability.Diffindo, Ability.ApparateAccess, Ability.WaterSpray,
        Ability.WaterSprayOrIce, Ability.HazardCleaner, Ability.Growth, Ability.Target, Ability.SilverDestroy,
        Ability.TargetPlusSilver, Ability.Intelligence, Ability.LaserDeflector, Ability.Adventure_HarryPotter], 
    ...
    <MinifigData>{ id: 7125501, name: 'Raven', skillIds: [Ability.MagicWalls, Ability.TeenTitansGoWorld,
        Ability.Magic, Ability.MagicShield, Ability.Flying, Ability.Laser, Ability.FlightPlusLaser, Ability.Electricity, 
        Ability.Drone, Ability.HazardProtection, Ability.Intelligence, Ability.LegoConstructs], 
        packId: 71255, image: 'wave-9-raven', state: PieceState.New, url: 'raven' },
    <MinifigData>{ id: 7125502, name: 'Beast Boy', skillIds: [Ability.TeenTitansGoWorld, Ability.Acrobat,
        Ability.MiniAccess, Ability.Boomerang, Ability.Flying, Ability.Dive, Ability.Atlantis, Ability.SlurpAccess,
        Ability.Drone, Ability.Digging, Ability.Tracking], 
        packId: 71255, image: 'wave-9-beast-boy', state: PieceState.New, url: 'beast-boy' },
    ...
    <MinifigData>{ id: 7134601, name: 'Blossom', skillIds: [Ability.Adventure_PowerpuffGirls, Ability.MiniAccess,
        Ability.Flying, Ability.LegoConstructs, Ability.Laser, Ability.FlightPlusLaser, Ability.Ice, 
        Ability.WaterSprayOrIce, Ability.EnergyShield, Ability.Intelligence, Ability.SuperStrength, Ability.Dive,
        Ability.XRay, Ability.HeartRegen, Ability.DivePlusXRay], 
        packId: 71346, image: 'wave-9-blossom', state: PieceState.New, url: 'blossom' },
    <MinifigData>{ id: 7134602, name: 'Bubbles', skillIds: [Ability.Adventure_PowerpuffGirls, Ability.MiniAccess,
        Ability.Flying, Ability.Laser, Ability.FlightPlusLaser, Ability.LegoConstructs, Ability.RainbowLego,
        Ability.SonarSmash, Ability.EnergyShield, Ability.Parseltongue, Ability.SuperStrength, Ability.Dive,
        Ability.Atlantis, Ability.HeartRegen, Ability.DivePlusLaser, Ability.DivePlusMini, Ability.DivePlusSonarSmash,
        Ability.DivePlusSuperStrength], 
        packId: 71346, image: 'wave-9-bubbles', state: PieceState.New, url: 'bubbles' },
];
