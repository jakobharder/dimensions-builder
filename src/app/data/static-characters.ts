...
export const minifigs: MinifigData[] = [
    ...
    <MinifigData>{ id: 7124401, name: 'Sonic the Hedgehog', skillIds: [Ability.SonicLevel, Ability.SonicWorld], 
        packId: 71244, image: 'wave-7-sonic-the-hedgehog', state: PieceState.Incomplete, url: 'sonic-the-hedgehog' },
    <MinifigData>{ id: 7125601, name: 'Stripe', skillIds: [Ability.GremlinsWorld], 
        packId: 71256, image: 'wave-7-stripe', state: PieceState.Incomplete, url: 'stripe' },
    <MinifigData>{ id: 7125602, name: 'Gizmo', skillIds: [Ability.GremlinsWorld], 
        packId: 71256, image: 'wave-7-gizmo', state: PieceState.Incomplete, url: 'gizmo' },
    <MinifigData>{ id: 7125701, name: 'Tina Goldstein', skillIds: [Ability.FantasticsBeastsWorld], 
        packId: 71257, image: 'wave-7-tina-goldstein', state: PieceState.Incomplete, url: 'tina-goldstein' },
    <MinifigData>{ id: 7125801, name: 'E.T.', skillIds: [Ability.ETWorld], 
        packId: 71258, image: 'wave-7-e-t', state: PieceState.Incomplete, url: 'e-t' },
    <MinifigData>{ id: 7128501, name: 'Marceline', skillIds: [Ability.Adventure_AdventureTime], 
