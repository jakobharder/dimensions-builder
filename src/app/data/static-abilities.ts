...
export const abilities: AbilityData[] = [
    ...
    <AbilityData>{ id: 12, url: 'laser', name: 'Laser', desc: 'destroy gold Lego objects; melt Lego ice', type: AbilityType.Normal, tags: [] },
    ...
    <AbilityData>{ id: 23, url: 'technology', name: 'Technology', desc: 'use technology panels', type: AbilityType.Normal, tags: [] },
    ...
    <AbilityData>{ id: Ability.RedDemonObjects, url: 'cursed-red-objects', name: 'Cursed Red Objects', desc: 'destroy cursed red demon objects', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
    <AbilityData>{ id: Ability.Disguise, url: 'scan-disguise', name: 'Scan Disguise', desc: 'use a disguise in at the security scan booth', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
    ...
    <AbilityData>{ id: Ability.ChargeTransfer, url: null, name: 'Charge Transfer', desc: '', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
    ...
    <AbilityData>{ id: Ability.Level_Midway, url: null, name: 'Midway Arcade Level', desc: '', type: AbilityType.LocationAccess, tags: [] },
    ...
    <AbilityData>{ id: Ability.Level_Ghostbusters, url: null, name: 'Ghostbusters Level', desc: '', type: AbilityType.LocationAccess, tags: [] },
