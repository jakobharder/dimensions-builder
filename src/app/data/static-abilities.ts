...
export const abilities: AbilityData[] = [
    ...
    <AbilityData>{ id: Ability.MagicWalls, url: 'magic-walls', name: 'Magic Walls', desc: 'teleport through purple magic walls', type: AbilityType.Normal, tags: [BuilderTag.Year2], extradesc: 'So far it is unclear if it will be a unique skill or available to more than one character.', image: 'magic-walls', actionClip: 'uxOBHpn1oDM' },
