...
export const abilities: AbilityData[] = [
    ...
    { id: Ability.Level_Portal2, url: null, name: '', desc: 'Portal 2 Level', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Portal2, url: null, name: 'Portal 2 Adventure World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Ninjago, url: null, name: '', desc: 'Ninjago Adventure World', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Chima, url: null, name: '', desc: 'Chima Adventure World', type: AbilityType.LocationAccess, tags: [] },
    ...
    { id: Ability.Level_BackToTheFuture, url: null, name: '', desc: 'Back to the Future Level', type: AbilityType.LocationAccess, tags: [] },
