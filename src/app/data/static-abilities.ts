...
export const abilities: AbilityData[] = [
    ...
    { id: 35, url: 'boomerang', name: 'Boomerang', desc: 'throw a boomerang at a switch', type: AbilityType.Normal, tags: [] },
    ...
    { id: Ability.MagnoGloves, url: 'magno-gloves', name: 'Magno Gloves', desc: 'climb walls with magnetic gloves', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
