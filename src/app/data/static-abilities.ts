...
export const abilities: AbilityData[] = [
    ...
    { id: Ability.Adventure_Simpsons, url: null, name: 'The Simpson Adventure World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_Simpsons, url: null, name: 'The Simpson Adventure World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Story_Batman, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Batman, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_Portal2, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Portal2, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Ninjago, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Chima, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    ...
    { id: Ability.Adventure_BackToTheFuture, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_BackToTheFuture, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_MissionImpossible, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_MissionImpossible, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_AdventureTime, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_AdventureTime, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_Midway, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Midway, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_LordOfTheRing, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_HarryPotter, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_KnightRider, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_KnightRider, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_Ghostbusters, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Ghostbusters, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_ScoobyDoo, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Oz, url: null, name: '', desc: '', type: AbilityType.LocationAccess, tags: [] }
