...
export const abilities: AbilityData[] = [
    ...
    { id: 16, url: 'rainbow-lego', name: 'Rainbow Lego Objects', desc: 'smash rainbow Lego objects', type: AbilityType.Normal, tags: [] },
    { id: 17, url: 'silver-destroy', name: 'Silver Lego Blowup', desc: 'destroy silver Lego objects', type: AbilityType.Normal, tags: [] },
    ...
    { id: Ability.RedDemonObjects, url: 'red-demon-objects', name: 'Red Demon Objects', desc: 'destroy red demon objects', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
    { id: Ability.Disguise, url: 'scan-disguise', name: 'Scan Disguise', desc: '', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
    { id: Ability.MagnoGloves, url: 'magno-gloves', name: 'Magno Gloves', desc: '', type: AbilityType.Normal, tags: [BuilderTag.Year2] },
    ...
    { id: Ability.Adventure_JurassicWorld, url: null, name: 'Jurassic World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_DC, url: null, name: 'DC Comics World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_ATeam, url: null, name: 'A-Team Adventure World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_LegoMovie, url: null, name: 'Lego Movie World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Simpsons, url: null, name: 'The Simpsons World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    ...
    { id: Ability.Adventure_Batman, url: null, name: 'Lego Batman World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_Portal2, url: null, name: 'Portal 2 Level', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Portal2, url: null, name: 'Portal 2 World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Ninjago, url: null, name: 'Ninjago World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Chima, url: null, name: 'Chima World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_DoctorWho, url: null, name: 'Doctor Who World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_DoctorWho, url: null, name: 'Doctor Who Level', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_BackToTheFuture, url: null, name: 'Back to the Future World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Level_BackToTheFuture, url: null, name: 'Back to the Future Level', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.MissionImpossibleWorld, url: null, name: 'Mission: Impossible World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.MissionImpossibleLevel, url: null, name: 'Mission: Impossible Level', desc: '', type: AbilityType.LocationAccess, tags: [] },
    ...
    { id: Ability.Adventure_Ghostbusters, url: null, name: 'Ghostbusters World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_ScoobyDoo, url: null, name: 'Scooby Doo World', desc: '', type: AbilityType.LocationAccess, tags: [] },
    { id: Ability.Adventure_Oz, url: null, name: 'The Wizard of Oz World', desc: '', type: AbilityType.LocationAccess, tags: [] },
