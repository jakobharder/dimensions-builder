...
export const levels: LevelData[] = [
    ...
    { url: 'ghostbusters-level', name: 'Ghostbusters Level', chapter: 0, story: 'Level Packs',
        abilitiesMinikits: [], abilitiesRescue: [], abilitiesExtra: [], abilitiesStory: [], access: Ability.Level_Ghostbusters, walkthrough: '' },

    { url: 'midway-arcade-level', name: 'Midway Arcade Level', chapter: 0, story: 'Level Packs',
        abilitiesMinikits: [], abilitiesRescue: [], abilitiesExtra: [], abilitiesStory: [], access: Ability.Level_Midway, walkthrough: '' },
    ...
    { url: 'main-story-1-follow-the-lego-brick-road', name: 'Follow The Lego Brick Road – Wizard Of Oz', chapter: 1, story: 'Main Story',
        ...
        access: -1, walkthrough: 'http://www.ign.com/wikis/lego-dimensions/Follow_the_LEGO_Brick_Road' },

    { url: 'main-story-2-meltdown-at-sector-7g', name: 'Meltdown at Sector 7-G – The Simpsons', chapter: 2, story: 'Main Story',
        abilitiesMinikits: [], abilitiesRescue: [], abilitiesExtra: [], abilitiesStory: [], access: -1, walkthrough: '' },
